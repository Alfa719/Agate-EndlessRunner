...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    public float areaStartOffset, areaEndOffset;

    private List<GameObject> spawnedTerrain;
    private float lastGeneratedPositionX, lastRemovedPositonX;
    ...
    void Start()
    {
        ...
        lastRemovedPositonX = lastGeneratedPositionX - terrainTemplateWidth;
    ...
    void Update()
    {
        ...
        while (lastRemovedPositonX + terrainTemplateWidth < GetHorizontalPositionStart())
        {
            lastRemovedPositonX += terrainTemplateWidth;
            RemoveTerrain(lastRemovedPositonX);
        }
    }
    ...
    private void GenerateTerrain(float posX, TerrainTemplateController forceTerrain = null )
    {
        ...
        newTerrain.transform.position = new Vector2(posX, 0);
